...
class Studio:
    ...
    def agenda(self, s, data):
        ...
        for i, it in enumerate(items):
            ...
            self._rect(s, 0.9, y + 0.66, 11.4, 0.015, self.p["line"])
    ...
    def _bullets(self, s, items, x, y, w, gap=0.62):
        for i, it in enumerate(items):
            yy = y + i * gap
            # bullet dot
    ...
    def build(self, brief: dict, out_path: str):
...
def main():
    ...
    out = studio.build(brief, args.out)
